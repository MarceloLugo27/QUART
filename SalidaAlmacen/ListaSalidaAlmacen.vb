...
Public Class ListaSalidaAlmacen
    ...
    Private Sub ListaSalidaAlmacen_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        MDIPrincipal.PantListaSalidas = False
    End Sub

    Private Sub ListaSalidaAlmacen_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnConsultar_Click(sender As System.Object, e As System.EventArgs) Handles btnConsultar.Click
        ...
        strConsulta = strqry & " " & strComplemento1 & " " & strComplemento2 & " and " & strCondicion1 & " and " & strCondicion2 & " and intUsuarioOrdenSalida > 0 order by idventa desc"
        LlenarDataGrid(strConsulta, dgvVentas)
        lblContar.Text = "Ventas Surtidas: " & dgvVentas.Rows.Count.ToString
        'intVenta = 0
        ProcedimientosGenerales.GrabarAccion(23)
    ...
    Private Sub btnImprimirVenta_Click(sender As System.Object, e As System.EventArgs) Handles btnImprimirVenta.Click
        SalidaAlamcen.GenerarSalidaAlmacen(intVenta)
    End Sub
