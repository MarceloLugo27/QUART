...
Public Class rptSalidaAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuartOK.rptSalidaAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalidaAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalidaAlmacen = New rptSalidaAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
