...
Public Class CompraNuevaPrevia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuartOK.CompraNuevaPrevia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompraNuevaPrevia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CompraNuevaPrevia = New CompraNuevaPrevia()
        rpt.Site = Me.Site
        Return rpt
    End Function
