...
Public Class frmModificarPermisos
    ...
    Private Sub ObtenerPermisosActivos()
        ...
        For i As Integer = 0 To renglones - 1 Step 1
            ...
            Dim strqry As String = "select intValor FROM tblPermisosUsuarios " & _
    ...
    Private Sub CancelarPermisosActuales()
        Dim strqry As String = "UPDATE [tblPermisosUsuarios] SET [intValor] = 0, [intVarControl] = 0, [dtFechaRetiro] = GETDATE(), [intUsuarioRetiro] =  " & intUsuario & _
    ...
    Private Sub GrabarPermisosNuevos()
        ...
        For i As Integer = 0 To renglones - 1 Step 1
            If dgvPermisos.Rows(i).Cells(2).Value = "HABILITADO" Then
                Dim strqry As String = "INSERT INTO tblPermisosUsuarios (idUsuario,idpermiso,intValor,intUsuarioOtorgo,intVarControl) VALUES (" & _
