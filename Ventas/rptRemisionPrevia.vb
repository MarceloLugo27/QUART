...
Public Class rptRemisionPrevia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuartOK.rptRemisionPrevia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRemisionPrevia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRemisionPrevia = New rptRemisionPrevia()
        rpt.Site = Me.Site
        Return rpt
    End Function
